...
//  =====================================================================
	 ...
	 */
	function efim(){
		document.getElementById("getsetid").setAttribute(
			'value',
			document.referrer.replace("http://www.ereality.ru/~","").replace("http://www.ereality.ru/","")
		);
	...
	function lotereya() {
		...
		if (document.getElementById("ImgField15")!=null){
			...
			arr.shuffle();
			for (i = 0; i < 5; i++) {
				xpath('//img[@src = "http://img.ereality.ru/loto/'+arr[i]+'_a.png"]').snapshotItem(0).click();
			}
		}
	...
	if (location.href.search("page=sostav") != -1 ) {
		...
		xpathRes.snapshotItem(0).removeChild(xpathRes.snapshotItem(0).lastChild);
		xpathRes = xpath("/html/body/table/tbody");
		xpathRes.snapshotItem(0).removeChild(xpathRes.snapshotItem(0).firstChild);
		xpathRes.snapshotItem(0).removeChild(xpathRes.snapshotItem(0).lastChild);
	}
		...
		if (document.getElementById("td_nick2")!=null ) {
			document.getElementById("td_nick2").insertBefore(
				exitlink,
				document.getElementById("td_nick2").firstChild
			);
		}
		document.getElementById("span_location").onclick= function(){
			document.getElementById('chat_msg').value = document.getElementById('span_location').innerHTML +
				' Людей: ' +
				document.getElementById('span_location_count').innerHTML;
		};
		...
		if (document.referrer.search("http://www.ereality.ru/info") != -1 || document.referrer.search("http://www.ereality.ru/~") != -1) {
			...
			xpathRes = xpath("/html/body/div[7]/div[22]/table/tbody/tr[3]/td/input[2]");
			xpathRes.snapshotItem(0).click();
		}
	}
		...
		if (document.referrer.search("http://www.ereality.ru/info") != -1 || document.referrer.search("http://www.ereality.ru/~") != -1) {
			...
			xpathRes = xpath("/html/body/div[5]/div[5]/div/div[3]/div/img[2]");
			xpathRes.snapshotItem(0).click();
		}
	}
	else if (location.href.search(".com/efimerka/") != -1) {
		if (document.referrer.search("http://www.ereality.ru/info") != -1 || document.referrer.search("http://www.ereality.ru/~") != -1) {
			xpathRes = xpath('//*[@id="sdiv_img8"]');
			xpathRes.snapshotItem(0).click();
		...
		if (document.referrer.search("http://www.ereality.ru/log") != -1) {
			...
			xpathRes = xpath("/html/body/center/form/table/tbody/tr[4]/td/input");
			xpathRes.snapshotItem(0).click();
		}
	}
	else if (location.href.search("http://cc.erclans.ru/viewpage.php") != -1) {
		if (document.referrer.search("http://www.ereality.ru/core/") != -1) {
			document.getElementById("0012e4f").setAttribute(
				'value',
				decodeURI(location.href).replace("http://cc.erclans.ru/viewpage.php?page_id=45#","").replace(/\] \[/g,",").replace("]","").replace("[","")
			);
			xpathRes = xpath("/html/body/table/tbody/tr/td/table[3]/tbody/tr/td[2]/table/tbody/tr[2]/td/center/form/input[2]");
			xpathRes.snapshotItem(0).click();
		}
	}
